...
//    template<typename T> void Push(unsigned count) { push::Push<T>(count); }
//    template<> void Push<float>(unsigned count) { push::Push<float>(count); }
//    template<> void Push<unsigned>(unsigned count) { push::Push<unsigned>(count); }
//    template<> void Push<unsigned char>(unsigned count) { push::Push<unsigned char>(count); }
    template<typename T>
    void Push(unsigned count)
    {
        std::cerr << "Error: Push<T> called\n";
